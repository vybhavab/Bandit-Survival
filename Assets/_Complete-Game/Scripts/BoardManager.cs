...

{
	...
	public class BoardManager : MonoBehaviour
	{
		...
		public GameObject[] fruitTiles;                   //Array of food prefabs.
		...
		public Count meatCount = new Count(1, 1);
		...
		public void SetupScene (int level)
		{
			...
			LayoutObjectAtRandom(fruitTiles, fruitCount.minimum, fruitCount.maximum);
			LayoutObjectAtRandom(vegTiles, vegCount.minimum, vegCount.maximum);
			LayoutObjectAtRandom(drinkTiles, drinkCount.minimum, drinkCount.maximum);
			LayoutObjectAtRandom(meatTiles, meatCount.minimum, meatCount.maximum);
